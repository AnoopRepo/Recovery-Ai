      ...
      <div className="flex-grow pt-[140px] px-6 md:px-12 pb-20 flex items-center justify-center">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-[var(--color-muted)]">Begin your path to digital balance</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-[var(--color-muted)]">
            Already have an account? <Link to="/login" className="text-[var(--color-accent)] font-bold hover:underline">Login here</Link>
          </div>
        </motion.div>
      </div>
      <Footer />
